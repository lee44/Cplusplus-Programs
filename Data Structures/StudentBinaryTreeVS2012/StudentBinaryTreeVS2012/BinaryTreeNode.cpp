...
BinaryTreeNode<Object>::BinaryTreeNode( const Object& theElement,BinaryTreeNode<Object> * theLeftSide, BinaryTreeNode<Object> * theRightSide ) {
	element = theElement;
...
template <class Object>
void BinaryTreeNode<Object>::setVisited()
{
	isVisited=true;
}
template <class Object>
bool BinaryTreeNode<Object>::getVisited()const
{
	return isVisited;
}
}
